...
public class Search_shoe_amazon {
...
WebElement e4=	c.findElement(By.id("add-to-cart-button"));
	
	
	e4.click();
	
	
	WebElement e5=c.findElement(By.name("proceedToRetailCheckout"));
...
WebElement address=c.findElement(By.id("shipToThisAddressButton"));
